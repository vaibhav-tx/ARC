...
export async function GET(request: Request) {
  try {
    ...
    const attendanceTrend = isDummyUser ? [
    ...
    const subjectAttendance = isDummyUser ? [
    ...
    const todaySchedule = isDummyUser ? [
    ...
    const kpis = isDummyUser ? {
      attendance: { value: "84%", sub: "This semester", trend: "+2%" },
      events: { value: "3", sub: "2 upcoming", trend: "+1" },
      fees: { value: "₹12k", sub: "Sem 6", trend: "Action" },
      orders: { value: "12", sub: "This month", trend: "+3" },
      applications: { value: "2", sub: "1 under review", trend: "+1" },
      resources: { value: "8", sub: "2 downloaded today", trend: "+2" },
    } : {
      attendance: { value: "0%", sub: "No data", trend: "0%" },
      events: { value: "0", sub: "0 upcoming", trend: "0" },
      fees: { value: "₹0", sub: "All clear", trend: "Clear" },
      orders: { value: "0", sub: "No orders", trend: "0" },
      applications: { value: "0", sub: "0 under review", trend: "0" },
      resources: { value: "0", sub: "0 downloaded today", trend: "0" },
    };
