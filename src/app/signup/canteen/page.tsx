  ...
  const handleDemoLogin = async () => {
    ...
    try {
      const res = await fetch("/api/login", {
        ...
        body: JSON.stringify({ email: "sanjay.canteen@campus.in", password: "Password@123", role: "canteen" }),
      })
      ...
      toast.success("Welcome! Entering Demo Canteen profile...")
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-zinc-400 mb-5">Create your canteen profile in 5 simple steps</p>
          ...
          <div className="inline-flex flex-col items-center gap-2 p-4 bg-gradient-to-r from-[#e78a53]/15 via-amber-500/10 to-[#e78a53]/15 border border-[#e78a53]/40 rounded-2xl backdrop-blur-md shadow-xl shadow-[#e78a53]/10">
            ...
            >
              ...
              <span>⚡ Instant Demo Canteen Profile (Bypass Registration)</span>
            </Button>
            <p className="text-xs text-amber-200/90 font-medium">
              Evaluator Mode: Clicks directly open the working Canteen Dashboard & Operations
            </p>
          </div>
        </div>
