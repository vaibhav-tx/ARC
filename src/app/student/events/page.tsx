...
export default function StudentEventsPage() {
  ...
  const demoEvents: Event[] = [
    { _id: "demo-e1", title: "Annual Tech Fest 2026", description: "Annual technology festival with coding competitions, hackathons and project exhibitions.", eventType: "academic", startDate: "2026-04-20", endDate: "2026-04-22", startTime: "09:00", endTime: "18:00", venue: "Main Auditorium", organizer: "CS Department", contactEmail: "techfest@campus.edu", maxParticipants: 500, registrationDeadline: "2026-04-18", fee: 0, status: "published", imageUrl: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=800", tags: ["coding", "hackathon", "tech"], requirements: [], isPublic: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { _id: "demo-e2", title: "Cultural Night — Rang De", description: "A colourful evening of dance, music and drama performances by students.", eventType: "cultural", startDate: "2026-04-25", endDate: "2026-04-25", startTime: "18:00", endTime: "22:00", venue: "Open Air Theatre", organizer: "Student Council", contactEmail: "council@campus.edu", maxParticipants: 800, registrationDeadline: "2026-04-23", fee: 50, status: "published", imageUrl: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&q=80&w=800", tags: ["dance", "music", "cultural"], requirements: [], isPublic: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { _id: "demo-e3", title: "AI/ML Workshop", description: "Hands-on workshop covering machine learning fundamentals, neural networks, and real-world deployment.", eventType: "workshop", startDate: "2026-05-03", endDate: "2026-05-04", startTime: "10:00", endTime: "17:00", venue: "Lab 301", organizer: "Prof. Priya Verma", contactEmail: "priya.verma@campus.edu", maxParticipants: 60, registrationDeadline: "2026-05-01", fee: 100, status: "published", imageUrl: "https://images.unsplash.com/photo-1555949963-aa79dcee981c?auto=format&fit=crop&q=80&w=800", tags: ["AI", "ML", "workshop"], requirements: ["Laptop"], isPublic: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { _id: "demo-e4", title: "Inter-College Cricket Tournament", description: "Two-day cricket tournament with 8 college teams competing for the campus trophy.", eventType: "sports", startDate: "2026-05-10", endDate: "2026-05-11", startTime: "08:00", endTime: "18:00", venue: "Sports Ground", organizer: "Sports Department", contactEmail: "sports@campus.edu", maxParticipants: 200, registrationDeadline: "2026-05-07", fee: 200, status: "published", imageUrl: "https://images.unsplash.com/photo-1531415074968-036ba1b575da?auto=format&fit=crop&q=80&w=800", tags: ["cricket", "sports", "tournament"], requirements: [], isPublic: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { _id: "demo-e5", title: "Guest Lecture: Industry 4.0", description: "A leading industry expert discusses the future of smart manufacturing, IoT and automation.", eventType: "seminar", startDate: "2026-04-30", endDate: "2026-04-30", startTime: "11:00", endTime: "13:00", venue: "Seminar Hall A", organizer: "Placement Cell", contactEmail: "placement@campus.edu", maxParticipants: 150, registrationDeadline: "2026-04-29", fee: 0, status: "published", imageUrl: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&q=80&w=800", tags: ["industry", "IoT", "career"], requirements: [], isPublic: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { _id: "demo-e6", title: "Photography Contest", description: "Capture campus life in a frame. Submit your best shots across 4 themes.", eventType: "cultural", startDate: "2026-05-07", endDate: "2026-05-07", startTime: "08:00", endTime: "20:00", venue: "Online + Campus", organizer: "Photography Club", contactEmail: "photoclub@campus.edu", maxParticipants: 100, registrationDeadline: "2026-05-05", fee: 0, status: "published", imageUrl: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&q=80&w=800", tags: ["photography", "contest"], requirements: ["Camera/Smartphone"], isPublic: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  ]
